...
public class FunctionUtil
{
    ...
    public FunctionUtil(StaticHiveFunctionInfo staticHiveFunctionInfo, ClassLoader classLoader)
    {
        this.classLoader = classLoader;
        this.funcName = staticHiveFunctionInfo.getHiveFunctionInfo().getFunctionName();
        this.className = staticHiveFunctionInfo.getHiveFunctionInfo().getClassName();
        this.initClazz();
    }

    public FunctionUtil(DynamicHiveFunctionInfo dynamicHiveFunctionInfo, ClassLoader classLoader)
    {
        this.classLoader = classLoader;
        this.funcName = dynamicHiveFunctionInfo.getFunctionName();
        this.className = dynamicHiveFunctionInfo.getClassName();
        this.initClazz();
    }
