...
public class RangerConfig
{
    ...
    public RangerConfig setPluginConfigResource(String pluginConfigResource)
    {
        this.pluginConfigResource = SPLITTER.splitToList(pluginConfigResource).stream()
                .map(File::new)
    ...
    public RangerConfig setHadoopConfigResource(String hadoopConfigResource)
    {
        this.hadoopConfigResource = SPLITTER.splitToList(hadoopConfigResource).stream()
                .map(File::new)
                .collect(toImmutableList());
        return this;
    }
